  ...
  return (
    <main className="min-h-screen bg-[#111827] text-white scroll-smooth">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10 md:p-10">
        {!isSearching && (
          <div className="bg-[#1F2937] rounded-2xl p-4 md:p-6 border border-gray-800 flex flex-col md:flex-row justify-between items-center mb-16 shadow-2xl gap-8 animate-in fade-in duration-500">
            <div className="w-full md:w-2/3 text-center md:text-left">
              <h1 className="text-3xl md:text-5xl font-extrabold uppercase mb-4 leading-tight font-[family-name:var(--font-candal)]">
                Kuasai Keahlian Digital <br className="hidden md:block" />
                <span className="text-blue-500">Masa Depan</span>
              </h1>
              <p className="text-gray-400 max-w-lg mx-auto md:mx-0 text-sm md:text-lg font-[family-name:var(--font-cabin)] leading-relaxed">
                Tingkatkan potensi dirimu dengan mempelajari teknologi paling
                dicari saat ini. Mulai dari{" "}
                <span className="text-slate-200">Pemrograman</span>,
                <span className="text-slate-200"> Web Development</span>, hingga
                <span className="text-slate-200"> AI</span> secara gratis.
              </p>
            </div>
        ...
        <section
          id="materi"
          className={`${isSearching ? "mt-10" : ""} bg-[#1F2937]/40 rounded-3xl p-8 md:p-12 border border-gray-800 shadow-2xl mb-16 scroll-mt-24`}
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold font-[family-name:var(--font-candal)] tracking-tight">
              {isSearching ? "Hasil" : "Materi"}{" "}
              <span className="text-blue-600">
                {isSearching ? "Pencarian" : "Pembelajaran"}
              </span>
            </h2>
